...
* При чтении по адресам 0100000-0115776 происходит выдача слова из массива, расположенного
...
|:---------:|---------------------------------------|-------------------------|
|0          | нет				    | __Сброс.__ <br>     Выполняется инициализация обмена с microSD-картой<br>и чтение файла map.txt|
