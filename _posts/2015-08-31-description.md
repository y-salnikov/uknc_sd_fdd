...
с необходимым размером в конце области памяти. Это сделано для того, чтобы блок начиная с адреса 23666 был доступен
...
&nbsp;&nbsp;&nbsp;&nbsp;
В ОЗУ ПП, получив управление драйвер устанавливается как обработчик событий канала 2. 